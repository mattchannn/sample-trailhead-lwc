...
import WireLDS from 'c/zcustWireLDS';
    ...
    describe('getRecord @wire data', () => {
        it('renders contact details', () => {
            ...
            return Promise.resolve().then(() => {
                ...
                const nameElement =
                    element.shadowRoot.querySelector('p.accountName');
                ...
                const phoneElement =
                    element.shadowRoot.querySelector('p.accountPhone');
                expect(phoneElement.textContent).toBe(
                    'Phone: ' + mockGetRecord.fields.Phone.value
                );

                const ownerElement =
                    element.shadowRoot.querySelector('p.accountOwner');
